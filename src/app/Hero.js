...
export default function Hero() {
    return (
        <div className="flex flex-row justify-between items-center w-full  px-5 py-10 gap-4 ">
            <div className={`w-60 h-100 flex items-start justify-center grow text-3xl  font-bold text-center ${playfair.className}`}>
