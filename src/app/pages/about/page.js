            ...
            <header className="desktop-header project-title w-full grid grid-cols-2 items-center justify-between   border-b border-[navy] shadow-lg border-opacity-50">
                ...
                <div className="w-full flex justify-end">
                    <a className="btn-back" href="/#projects">
                        <Backarrow className="w-10 h-10" /> Back to Projects
                    </a>
                </div>
                                ...
                                timelineItems.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div
                                            ...
                                            `}
                                        >
                                            <div className="journey-card w-[90%] border-l-4 border-[#F7A5A5] rounded-lg py-6 px-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="main-stack-container">
                    ...
                    <div className="main-stack-card">
                        ...
                        <div className="icon-container">
                            ...
                            <ReactIcon className="icon w-14 h-14 rounded-lg" />
                    ...
                    <div className="main-stack-card">
                        ...
                        <div className="icon-container">
                            ...
                            <ResponsiveIcon className="icon w-14 h-14 rounded-lg" />
